     ...
     const loadDesign = (design) => {
        fetch(`${design}.html`)
            ...
            .then(html => {
                ...
                if (chat) signature.querySelector('#chat').textContent = chat;
